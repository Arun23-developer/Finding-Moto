    ...
    const loadProfile = async () => {
      ...
      try {
        ...
        setForm({
          ...
          shopDescription: p.shopDescription || "Expert motorcycle repair and maintenance services. We specialize in providing high-quality solutions for all your biking needs.",
          ...
          <Card className="glass-card border border-border/40 overflow-hidden shadow-lg">
             <div className="relative h-48 bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-800">
                ...
                <div className="absolute -bottom-10 left-8">
                   <div className="h-28 w-28 rounded-3xl bg-card border-[6px] border-card shadow-2xl flex items-center justify-center overflow-hidden">
                      {avatar ? (
                ...
                {editing ? (
                   ...
                   <div className="space-y-8">
                      <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
                         <div>
                            <h2 className="text-3xl font-black text-foreground tracking-tight">{form.workshopName || "Finding Moto Workshop"}</h2>
                            <div className="flex flex-wrap items-center gap-2 mt-3">
                               <Badge className="bg-blue-600 border-none text-[9px] font-black uppercase tracking-widest px-2.5 py-1 shadow-lg shadow-blue-500/20">
                                  {form.specialization || "Automotive Excellence"}
                               </Badge>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-12 px-2">
                         ...
                         <div className="flex items-center gap-3 group">
                            ...
                            <div>
                               ...
                               <p className="text-sm font-bold text-foreground">{form.website || "findingmoto.com"}</p>
                            </div>
                         </div>
                      </div>
                   </div>
          ...
          <Card className="glass-card border border-border/40 overflow-hidden shadow-sm">
             ...
             <CardContent className="p-8">
                <div className="flex flex-wrap gap-2">
                   {(form.servicesOffered.length > 0 ? form.servicesOffered : ["General Maintenance", "Performance Tuning"]).map(s => (
