...
const categories = ["All", "Engine", "Brakes", "Electronics", "Performance", "Accessories", "Drivetrain", "Controls", "Luggage"];
const brands = ["All Brands", "Brembo", "Akrapovic", "K&N", "RK", "CRG", "Renthal", "Magura", "SW-Motech", "J.W. Speaker"];
const sortOptions = ["Most Popular", "Price: Low to High", "Price: High to Low", "Newest", "Best Rating"];
